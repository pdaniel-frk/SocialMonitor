										...
										<cfoutput query="getTerms">
											<tr>
												...
												<td nowrap>
													...
													<button class="btn btn-info btn-small run-schedule" data-scheduleid="#scheduleId#" data-service="instagram" data-toggle="tooltip" data-placement="bottom" title="Run this task">
														<span class="glyphicon glyphicon-play-circle"></span>
													</button>
													<button class="btn btn-default btn-small export-entries" data-scheduleid="#scheduleId#" data-service="instagram" data-toggle="tooltip" data-placement="bottom" title="Export collected entries">
