...
<cfquery name="getTerms" datasource="#this.dsn#">
	select
		...
		s.startDate,
		s.endDate,
		(select count(1) from InstagramEntries where searchTerm = s.searchTerm) as entry_count
	from Schedules s
	where isdate(s.deleteDate) = 0
	and s.service = 'Instagram'
</cfquery>


<h1 class="page-header">
	Instagram &raquo; Monitored Terms
</h1>
										...
										<cfoutput query="getTerms">
											<tr>
												...
												<td nowrap>
													...
													<button class="btn btn-info btn-xs run-schedule" data-scheduleid="#scheduleId#" data-service="instagram" data-toggle="tooltip" data-placement="bottom" title="Run this task">
														<span class="glyphicon glyphicon-play-circle"></span>
													</button>
													<a href="#request.webRoot#show_entries.cfm?scheduleId=#scheduleId#">
														<button class="btn btn-primary btn-xs view-entries" data-scheduleid="#scheduleId#" data-service="instagram" data-toggle="tooltip" data-placement="bottom" title="View collected entries">
															<span class="glyphicon glyphicon-eye-open"></span>
														</button>
													</a>
													<button class="btn btn-default btn-xs download-entries" data-scheduleid="#scheduleId#" data-service="instagram" data-toggle="tooltip" data-placement="bottom" title="Download collected entries">
