...
<cfset formTitle = 'New Instagram Search Term Monitor'>
...
<cfoutput>
<form name="monitorForm" method="post" action="services/monitor-instagram-term.cfm">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="text-center">
					<button type="button" class="btn btn-danger btn-stop-instagram-term-monitor">STOP MONITORING THIS SEARCH TERM <span class="glyphicon glyphicon-eye-close"></span></button>
				</div>
			</div>
		</div>
	</cfif>
	<div class="modal-footer">
		...
		<button type="button" class="btn btn-primary btn-save-instagram-term-monitor">Save changes</button>
