...
<cfif len(url.searchTerm) or len(url.scheduleId)>
	...
	<cfif getScheduleInfo.recordCount>
		<cfset formTitle = 'Edit Twitter Search Term Monitor - #getScheduleInfo.searchTerm#'>
...
<cfoutput>
<form name="monitorForm" method="post" action="services/monitor-twitter-term.cfm">
